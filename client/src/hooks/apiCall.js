...
export const getCartdata=async()=>{
    const response=await axios.get('http://localhost:3000/api/cart/products',{
        withCredentials: true
    })
...
export const updateProductDataByID = async (productId, data) => {
    ...
    try {
      ...
      console.log("Error in updating product data=>", error);
    }
};
...
export const getTotalPrice = async () => {
    try {
      ...
      console.log("Error in getting totalProduct:", error);
      return 0;
    }
  };

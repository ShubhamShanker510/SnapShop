...
import { reviewData1 } from '../../data.js';
import VerticalCards from '../../components/vertical_cards/VerticalCards.jsx';
...
import {addtoCart, updateWihlistData} from '../../hooks/apiCall.js'
                    ...
                    <div className="right flex flex-col">
                        ...
                        <div className="btn flex items-center">
                            <div className="cartbtn border border-red-600 px-[100px] py-1 bg-red-600 text-white rounded-sm hover:bg-white hover:text-red-600 mr-3 cursor-pointer shadow shadow-sm shadow-gray-700">
                                <button  onClick={()=>HandleCart(data1.id, data1.image, data1.title, data1.description, data1.price*200, data1.rating.rate, data1.category)}
                      >ADD TO CART</button>
                            </div>
